...
const MoveModeControls: React.FC<MoveModeControlsProps> = ({ onSave, onCancel }) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-surface-light dark:bg-surface-container-dark border-t border-outline-variant-light dark:border-outline-variant-dark shadow-[0_-4px_12px_rgba(0,0,0,0.1)] dark:shadow-[0_-4px_12px_rgba(0,0,0,0.3)] z-50">
